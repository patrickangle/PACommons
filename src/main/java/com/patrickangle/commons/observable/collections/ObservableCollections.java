...
public final class ObservableCollections {
    ...
    public static <E> ObservableList<E> observableList(Class<E> valueClass) {
        return ObservableCollections.observableList(new ArrayList<E>());
    }
    
    public static <E> ObservableList<E> concurrentObservableList(List<E> list) {
        if (list == null) {
            throw new IllegalArgumentException("List must be non-null");
        }
        return ObservableCollections.observableList(new CopyOnWriteArrayList<>(list));
    }
    
    public static <E> ObservableList<E> concurrentObservableList(Class<E> valueClass) {
        return ObservableCollections.observableList(new CopyOnWriteArrayList<E>());
    }
