...
//        defaults.put("ButtonUI", ModernCheckBoxUI.class.getName());
//        defaults.put("ToggleButtonUI", ModernCheckBoxUI.class.getName());
//        defaults.put("Button.border", ModernCheckBoxUI.getDefaultBorder());
//    }
//    
