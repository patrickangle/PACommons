...
public class ModernCheckIcon implements Icon {
        ...
        private static final int CORNER_DIAMETER = 6;
        
        private static final Shape ICON_SHAPE = new RoundRectangle2D.Double(0, 0, CHECK_BOX_SIZE, CHECK_BOX_SIZE, CORNER_DIAMETER, CORNER_DIAMETER);
        ...
        public void paintIcon(Component c, Graphics graphics, int x, int y) {
            ...
            if (button.getModel().isSelected()) {
                ModernUIComponentPainting.paintComponentCheckMark(g, c, ICON_SHAPE);
            }
        }

        @Override
        public int getIconHeight() {
            return CHECK_BOX_SIZE + (GENERAL_PADDING * 2);
        }
