 ...
 */
package com.patrickangle.commons.laf.modern.keybindings;
...
public class MacKeyBindings {
    public static void installKeybindings(UIDefaults table) {
        ...
        final MacKeyBindings keyBindings = new MacKeyBindings();
        
        table.put("Button.focusInputMap", controlFocusInputMap);
        table.put("CheckBox.focusInputMap", controlFocusInputMap);
        table.put("ComboBox.ancestorInputMap", keyBindings.getComboBoxInputMap());
        table.put("EditorPane.focusInputMap", keyBindings.getMultiLineTextInputMap());
        table.put("FormattedTextField.focusInputMap", keyBindings.getFormattedTextFieldInputMap());
        table.put("List.focusInputMap", keyBindings.getListInputMap());
        table.put("PasswordField.focusInputMap", keyBindings.getPasswordFieldInputMap());
        table.put("RadioButton.focusInputMap", controlFocusInputMap);
        table.put("ScrollBar.focusInputMap", keyBindings.getScrollBarInputMap());
        table.put("ScrollBar.focusInputMap.RightToLeft", keyBindings.getScrollBarRightToLeftInputMap());
        table.put("ScrollPane.ancestorInputMap", keyBindings.getScrollPaneInputMap());
        table.put("Slider.focusInputMap", keyBindings.getSliderInputMap());
        table.put("Slider.focusInputMap.RightToLeft", keyBindings.getSliderRightToLeftInputMap());
        table.put("Spinner.ancestorInputMap", keyBindings.getSpinnerInputMap());
        table.put("Table.ancestorInputMap", keyBindings.getTableInputMap());
        table.put("Table.ancestorInputMap.RightToLeft", keyBindings.getTableRightToLeftInputMap());
        table.put("TextArea.focusInputMap", keyBindings.getMultiLineTextInputMap());
        table.put("TextField.focusInputMap", keyBindings.getTextFieldInputMap());
        table.put("TextPane.focusInputMap", keyBindings.getMultiLineTextInputMap());
        table.put("ToggleButton.focusInputMap", controlFocusInputMap);
        table.put("Tree.focusInputMap", keyBindings.getTreeInputMap());
        table.put("Tree.focusInputMap.RightToLeft", keyBindings.getTreeRightToLeftInputMap());
        table.put("Tree.ancestorInputMap", new UIDefaults.LazyInputMap(new Object[]{"ESCAPE", "cancel"}));
        table.put("ScrollPane.ancestorInputMap.RightToLeft", new UIDefaults.LazyInputMap(new Object[]{}));
    }
    
    private static final MacKeyBindings instance = new MacKeyBindings();
    static MacKeyBindings instance() {
        return instance;
    }
